...
const { analyzeResume } = require("../services/geminiService.js")

const { diffText, summarize } = require("../services/diffService.js");

const { extractText } = require("../services/pdfServices.js")
...
router.post(
    ...
    asyncHandler(async (req, res) => {
        ...
        let versionId = req.body.versionId || resume.currentVersionId;
        //Ex
        if (!versionId) {
...
function patchBulletInSections(sections, rewrites) {
...
router.post(
    ...
    asyncHandler(async (req, res) => {
        ...
        // Geminis re-parse fails.
        const patchedFromBase = patchBulletInSections(
...
router.get(
    ...
    asyncHandler(async (req, res) => {
        ...
        const parts = diffText(fromV.rawText, toV.rawText, req.query.model);
        res.json({
