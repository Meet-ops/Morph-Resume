...
function buildPrompt({ rawText, targetRole }) {
    return [
        ...
        "Return exactly 5 prioritised issues, 5 standouts strengths, and 5-10 weak bullets rewritten to be stronger, quantified, and ATS-friendly",
        "Rewrites must preserve the original meaning. Each rewrites needs a one-line rationale",
        "Identity keywords clearly present and notable keywords missing for the apparent target role.",
